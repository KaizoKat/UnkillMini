...
if not exist "%BIN_DIR%" (
    echo Error: bin directory not found. Please compile the project first.
    PAUSE
    exit /b 1
)
...
java -Xms256m -Xmx512m -XX:+UseG1GC -XX:TieredStopAtLevel=1 -cp "%BIN_DIR%;%CLASSPATH%" io.github.pws.unkillmini.Application
